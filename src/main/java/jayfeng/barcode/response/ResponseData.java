package jayfeng.barcode.response;
...
public class ResponseData {
     ...
     * @return 返回 ResponseData 对象
     */
    public static ResponseData createFailResponseData(String infoKey, String failMessage, String failType) {
        RequestFailMessage failMessageObj = new RequestFailMessage(failMessage, failType);
        return createFailResponseData(infoKey, null, failMessageObj);
    }
